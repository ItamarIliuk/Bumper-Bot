                                    ...
                                    tf_listener_(tf_buffer_)
{
    ...
    // Service Server
    get_transform_srv_ = nh_.advertiseService("get_transform", &SimpleTfExamples::getTransformCallback, this);
...
bool SimpleTfExamples::getTransformCallback(bumperbot_examples::GetTransform::Request &req,
